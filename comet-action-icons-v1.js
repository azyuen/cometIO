...
(() => {
  ...
  GameScene.prototype.choice = function (x, y, label, color, risk) {
    ...
    const a = this.add.text(0, 24, label, {fontFamily: FONT, fontSize: '16px', fontStyle: 'bold', color: '#fff'}).setOrigin(.5);
    const b = this.add.text(0, 42, risk, {fontFamily: FONT, fontSize: '8px', fontStyle: 'bold', color: `#${color.toString(16).padStart(6, '0')}`}).setOrigin(.5);
