...
assert(index.includes('comet-collection-scroll-polish-v1.js?v=2'), 'collection scroll polish must be cache-busted');
...
assert(index.indexOf('comet-collection-scroll-polish-v1.js?v=2') > index.indexOf('comet-science-learning-v1.js?v=2'), 'collection polish must load after science collection wrapper');
