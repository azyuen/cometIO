...
(() => {
  ...
  const FACTS = {
    ...
    nebula_n49:['N49','N49 is the brightest known supernova remnant in the Large Magellanic Cloud.','Its tangled sheets of glowing debris are the wreckage of a massive stellar explosion, and the remnant also contains an extremely energetic neutron star.'],
    nebula_n132d:['N132D','N132D is an oxygen-rich supernova remnant in the Large Magellanic Cloud, produced by a massive star that exploded roughly 3,000 years ago.','Fast ejecta are still slamming into surrounding gas, creating bright shock fronts across a remnant tens of light-years wide.'],
    pulsar_b0540_69:['PSR B0540−69','PSR B0540−69 is a young pulsar in the Large Magellanic Cloud often compared with the Crab Pulsar.','It produces about 20 X-ray pulses each second and powers a surrounding pulsar-wind nebula.'],
    blackHole_lmcX3:['LMC X-3','LMC X-3 is a stellar-mass black-hole binary in the Large Magellanic Cloud with an orbital period of about 1.7 days.','Its unseen compact companion was one of the earliest strong extragalactic cases for a stellar-mass black hole.'],
    pulsar_m82_x2:['M82 X-2','M82 X-2 is an ultraluminous X-ray source in the starburst galaxy M82 that turned out to be a pulsar, not a black hole.','NuSTAR detected its regular X-ray pulses, proving that a neutron star can produce extraordinary ULX-level luminosity.'],
    blackHole_m82X1:['M82 X-1','M82 X-1 is the brightest X-ray source in M82 and a leading intermediate-mass black-hole candidate.','X-ray timing measurements have been interpreted as evidence for a black hole of roughly 400 solar masses, placing it between ordinary stellar and supermassive black holes.'],
    blackHole_antennaeX11:['ANTENNAE X-11','X-11 is an ultraluminous X-ray source inside the merging Antennae Galaxies.','Its extreme X-ray output makes an accreting black hole a strong candidate, although ULX compact-object classifications can remain uncertain.']
  };
